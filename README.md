...
Made with Python 3.13. Simply run the script and it'll make a new folder called system_palettes, with 2 folders 
containing every act/pal respectively The script uses a "formats" variable in Main to generate colours. 
